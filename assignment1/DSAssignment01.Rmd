...
7. Create a matrix to represent the medal table for the 2022 Beijing Winter Olympics shown here: https://olympics.com/en/olympic-games/beijing-2022/medals. If you just want to use the first few countries that’s fine. Assign names to the (Country) rows and medal type (columns).
```{r}
A = matrix(
